...
namespace Axiom.Utilities
{
	...
	public static class Proclaim
	{
		...
		public static Exception Unreachable
		{
			get
			{
                UnityEngine.Debug.Assert(false, "Unreachable");
		...
		{
            UnityEngine.Debug.Assert(!String.IsNullOrEmpty(str));
		}
		...
		{
            UnityEngine.Debug.Assert(items != null && items.Count > 0);
		}
		...
		{
            UnityEngine.Debug.Assert(items != null);
