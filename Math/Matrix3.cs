...
namespace Axiom.Math
{
	...
	public struct Matrix3
	{
		...
		{
			UnityEngine.Debug.Assert( col >= 0 && col < 3, "Attempt to retreive a column of a Matrix3 greater than 2." );
		...
		{
			UnityEngine.Debug.Assert( col >= 0 && col < 3, "Attempt to set a column of a Matrix3 greater than 2." );
